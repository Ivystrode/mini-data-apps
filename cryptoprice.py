...
image = Image.open("btclogo.jpeg")
st.image(image, width=500)
st.title("CRYPTO price app")
st.markdown("""
            This app retrieves crypto prices isn't that fucking amazing
            """)

expander_bar = st.expander("About")
expander_bar.markdown("""
                      Streamlit displays this web app and we get the data from coinmarketcap
                      """)
...
currency_price_unit = col1.selectbox("Select currency to display price as", ("USD","BTC","ETH"))
...
def load_data():
    ...
    data = soup.find("script", id="__NEXT_DATA__", type="application") # select? select_one? find/findall???
    print("get that data...")
    print(data)
    coins = {}
...
def filedownload(df):
    ...
    b64 = base64.b64encode(csv.encode()).decode()  # have to strings to bytes
